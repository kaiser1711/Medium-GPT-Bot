# code is from https://github.com/kaili-chen/writing-supplements/tree/master/publish%20to%20medium%20via%20cli
...
def get_author_id():
    ...
    response = requests.get("https://api.medium.com/v1/me", headers=headers, params={"Authorization": "Bearer {}".format(config.TOKEN)})
